...
Original file is located at
    https://colab.research.google.com/drive/16tTQlf2hE9fkRzWfErpMm1dBmqbFyAk7
...
"""*   **Store**: Since 'Store' is a nominal categorical feature.
*   **DayOfWeek**: 'DayOfWeek' is an ordinal categorical feature. *   **Promo**: 'Promo' is already a binary feature (0 or 1), so it doesn't require further encoding.
*   **SchoolHoliday**: 'SchoolHoliday' is also a binary feature (0 or 1) and doesn't require further encoding.

Q6. Encode any categorical features (e.g., DayOfWeek) appropriately.
"""

# Apply One-Hot Encoding to 'Store' and 'DayOfWeek'
X_encoded = pd.get_dummies(X, columns=['Store', 'DayOfWeek'], drop_first=True)
X_encoded
